...
--
-- Host: 127.0.0.1
-- Generation Time: May 17, 2020 at 07:21 PM
...
INSERT INTO `assignment` (`assign_ID`, `assign_name`, `assign_teacher`, `assign_dep`, `assign_stage`, `assign_subject_ID`, `assign_subject`) VALUES
(1, 'Installments and T2 Report Card Collection.pdf', 4, 2, 2, 0, ''),
(3, 'iOS- How to Install Microsoft Teams.pdf', 5, 3, 4, 0, ''),
(4, 'SABIS Online Learning-How To Guide For Students and Parents EngArKur.pdf', 5, 3, 2, 0, ''),
(5, 'Kurdish.pdf', 5, 3, 2, 0, ''),
(6, 'New Microsoft Word Document.docx', 5, 3, 2, 0, ''),
(7, 'How to Earn a Reading Certificate EngARKur.pdf', 5, 3, 2, 0, ''),
(8, 'SABIS Online Learning-How To Guide For Students and Parents EngArKur.pdf', 5, 3, 2, 0, ''),
(9, 'SABIS Online Learning-How To Guide For Students and Parents EngArKur.pdf', 5, 3, 3, 0, ''),
(10, 'ڕێزمان و خوێندنەوەی کوردی4280318413184369260.pdf', 5, 3, 2, 0, ''),
(11, 'How to Earn a Reading Certificate EngARKur.pdf', 5, 3, 2, 0, ''),
(12, 'Screenshot_2.png', 5, 3, 2, 0, ''),
(13, 'Screenshot_4.png', 5, 3, 1, 0, ''),
(14, 'Screenshot_4.png', 5, 3, 2, 0, 'analaytical chemistry');
...
CREATE TABLE `material` (
  ...
  `mat_subject_ID` int(11) NOT NULL,
  `mat_subject` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `material` (`mat_ID`, `mat_name`, `mat_teacher`, `mat_dep`, `mat_stage`, `mat_subject_ID`, `mat_subject`) VALUES
(1, 'Kurdish.pdf', 4, 2, 2, 0, ''),
(2, 'iOS- How to Install Microsoft Teams.pdf', 4, 2, 2, 0, ''),
(4, 'How to Earn a Reading Certificate EngARKur.pdf', 4, 2, 2, 0, ''),
(5, 'SABIS KG Online Learning-How To Guide For Students and Parents.pdf', 4, 2, 2, 2, 'operating system'),
(6, 'ڕێزمان و خوێندنەوەی کوردی4280318413184369260.pdf', 4, 2, 2, 0, ''),
(8, 'iOS- How to Install Microsoft Teams.pdf', 5, 3, 3, 0, ''),
(9, 'Installments and T2 Report Card Collection.pdf', 5, 3, 3, 0, ''),
(10, 'Kurdish.pdf', 5, 3, 3, 0, ''),
(11, 'Letter - online courses and AMS quizzes.pdf', 5, 3, 2, 0, ''),
(12, 'New Timetable announcement.pdf', 5, 3, 2, 0, ''),
(13, 'trans.docx', 5, 3, 2, 0, ''),
(14, 'Screenshot_3.png', 5, 3, 3, 0, ''),
(15, 'Screenshot_2.png', 5, 3, 3, 0, ''),
(16, 'Screenshot_3.png', 5, 3, 3, 0, ''),
(17, 'Screenshot_2.png', 4, 2, 2, 0, 'inorganic chemistry'),
(18, 'Screenshot_2.png', 5, 3, 3, 11, 'quantum chemistry');
...
(6, 'artifical intelligent', '8', 2, 3, '', 0),
